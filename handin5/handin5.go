...
func GarbledCircuit(recipient Bloodtype, donor Bloodtype) bool {
	...
	alice.Decrypt(&elGamal, e_x)                      // Alice decrypts the ?wire values? from Bob and stores them locally in the Alice struct
	...
	z := alice.EvaluateGarbledCircuit(F, d, e_xor, ciphertexts)
